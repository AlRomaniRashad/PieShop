...
namespace PieShop.Models
{
    public class AppDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        #region SeedDataAdded
        // This method used to tell the migration how to build the model and to insert data into database
        // this method take place when we add migration 
